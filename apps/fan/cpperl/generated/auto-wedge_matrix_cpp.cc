...
// To change the number of instances per source file, specify "chunksize":N in ../auto-wedge_matrix_cpp.cpperl

#define POLYMAKE_CPPERL_FILE "auto-wedge_matrix_cpp"
