...
for(my $i=0; $i<3; $i++){
   ...
   push @rows_k3, new Vector<Int>(topaz::betti_numbers($d));
}
...
for(my $i=0; $i<3; $i++){
   ...
   push @rows_cube2, new Vector<Int>(topaz::betti_numbers($d));
}
...
for(my $i=0; $i<4; $i++){
   ...
   push @rows_cube3, new Vector<Int>(topaz::betti_numbers($d));
}
...
for(my $i=0; $i<3; $i++){
   ...
   push @rows_cubicSurface, new Vector<Int>(topaz::betti_numbers($d));
}
